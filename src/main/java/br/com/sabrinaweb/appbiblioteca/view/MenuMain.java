...
public class MenuMain {
    ...
    public MenuMain(BookService bookService, AuthorService authorService, LibraryLoanService libraryLoanService, UserService userService, Scanner scanner) {
        ...
        try {
            ...
            do {
                switch (menuResp) {
                    ...
                    default -> throw new IllegalArgumentException("Invalid option you must enter the available options. Exiting...");
                }
                if (menuResp != 0) {
                    showMenuOptions();
    ...
    public void bookMenu() {
        try {
            ...
            System.out.println("6 - Find book(s) of an author");
    ...
    public void userMenu() {
        try {
            ...
            switch (resp) {
                ...
                case 9 -> System.out.println("Coming back to the principal menu...");
                default ->
                        throw new IllegalArgumentException("Invalid option you must enter the available options :).");
            }
        } catch (IllegalArgumentException e) {
            log.error(e);
        }
    ...
    public void loanMenu() {
        ...
        } catch (IllegalArgumentException | InvalidLoanException | IllegalStateException |
                 BookNotAvailableForLoanException e) {
    ...
    public void reportMenu() {
        try {
            ...
            switch (resp) {
                case 1 -> bookService.theMostBorrowedBook();
